...
#import "MathMageAppDelegate.h"

@implementation MathMageAppDelegate
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.mainMenuVC = [[MainMenuVC alloc] initWithNibName:@"MainMenuVC" bundle:nil];
    self.mainMenuVC.title = @"Math Mage";
